...
test_KL_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY() {
    ...
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS"\
            ...
            "SOLVER_MAX_ITERATIONS" "PRECONDITIONER_ORDER" "PRECONDITIONER_MASS" \
            "PRECONDITIONER_SOLVER_EPSILON" "PRECONDITIONER_MSCG_EPSILON" \
...
test_ZOLOTAREV_INVERT_ITERABLE_PARAMETERS_NAMES_ARRAY() {
    ...
    local expected_array=("GAUGE_LINKS_CONFIGURATION_LABEL" "NUMBER_OF_VECTORS"\
            ...
            "SOLVER_INNER_MAX_ITERATIONS" "SCALING_FACTOR" "LANCZOS_EPSILON" \
            "LANCZOS_MAX_ITERATIONS" "DELTA_MIN" "DELTA_MAX" "SOLVER_EPSILON" \
            "SOLVER_MAX_ITERATIONS" "PRECONDITIONER_SOLVER_EPSILON" \
            "PRECONDITIONER_MSCG_EPSILON" "PRECONDITIONER_MAX_ITERATIONS")
